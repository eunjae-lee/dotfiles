...
4. Review the diff yourself, focusing on things the agents rules would NOT catch:
   - Bugs, logic errors, edge cases, race conditions
   - Security issues (injection, hardcoded secrets, improper auth)
   - Whether the PR description accurately describes the changes
